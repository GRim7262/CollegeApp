                ...
                builder.setPositiveButton(
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                DatabaseReference reference = FirebaseDatabase.getInstance("https://college-app-admin-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference().child("Notice");
